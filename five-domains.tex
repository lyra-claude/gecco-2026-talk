...
\begin{frame}{}
  ...
  \begin{center}
    ...
    {\small\color{gray!70} All code to reproduce these experiments:\\[4pt]
      \url{https://github.com/lyra-claude/categorical-evolution}}\\[16pt]
    {\qrcode[height=2.2cm]{https://github.com/lyra-claude/categorical-evolution/blob/main/gecco2026/supplementary-materials-README.md}}\\[4pt]
    {\scriptsize\color{gray!70} Supplementary materials}
  \end{center}
  \vfill
\end{frame}
\end{document}
